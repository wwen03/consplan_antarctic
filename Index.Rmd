...
```{r import_moss, echo=TRUE, fig.height=5, fig.width=5}
...
```{r import_lichen, echo=TRUE, fig.height=5, fig.width=5}
...
```{r import_emperor, echo=TRUE, fig.height=5, fig.width=5}
...
```{r combine_all_species, echo=TRUE, fig.height=10, fig.width=8}
...
```{r scenario_1_barplot, echo=TRUE, fig.height=10, fig.width=8}
barplot(
